...
## hard coded version without any defensive programming
# x = [1,3,5]
# def num_ways_x(n)
#     return 1 if n == 0 || n == 1
#     return num_ways_x(n-1) + num_ways_x(n-3) + num_ways_x(n-5)
# end

puts "n = 0: #{num_ways_x(0)}"
puts "------"
puts "n = 1: #{num_ways_x(1)}"
puts "------"
puts "n = 2: #{num_ways_x(2)}"
puts "------"
puts "n = 3: #{num_ways_x(3)}"
puts "------"
puts "n = 4: #{num_ways_x(4)}"
puts "------"
puts "n = 5: #{num_ways_x(5)}"
puts "------"
puts "------"
x = [1,3,5]
puts "with x = 1,3,5"
puts "n = 0: #{num_ways_x_bottom_up(0,x)}"
puts "------"
puts "n = 1: #{num_ways_x_bottom_up(1,x)}"
puts "------"
puts "n = 2: #{num_ways_x_bottom_up(2,x)}"
puts "------"
puts "n = 3: #{num_ways_x_bottom_up(3,x)}"
puts "------"
puts "n = 4: #{num_ways_x_bottom_up(4,x)}"
puts "------"
puts "n = 5: #{num_ways_x_bottom_up(5,x)}"
puts "------"
puts "------"
x = [1,2,3]
puts "with x = 1,2,3"
